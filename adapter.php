...
<?php
                    ...
                    <div class="col-sm-9 padding-right">
                        <div class="features_items"><!--features_items-->
                            <h2 class="title text-center">Кабели и Переходники</h2>
                            <div class="col-sm-4">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="images/home/ada1.jpg" alt="" />
                                            <h2><?php echo $row73['price'];?>₽</h2>
                                            <p><?php echo $row73['name'];?></p>
                                            <a href="ada1.php" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Купить</a>
                                        </div>
                            ...
                            <div class="col-sm-4">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="images/home/ada2.jpg" alt="" />
                                            <h2><?php echo $row74['price'];?>₽</h2>
                                            <p><?php echo $row74['name'];?></p>
                                            <a href="ada2.php" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Купить</a>
                                        </div>
                                        <div class="product-overlay">
                                            <div class="overlay-content">
                                            <h2><?php echo $row74['price'];?>₽</h2>
                            ...
                            <div class="col-sm-4">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="images/home/ada3.jpg" alt="" />
                                            <h2><?php echo $row75['price'];?>₽</h2>
                                            <p><?php echo $row75['name'];?></p>
                                            <a href="ada3.php" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Купить</a>
                                        </div>
                                        <div class="product-overlay">
                                            <div class="overlay-content">
                                               <h2><?php echo $row75['price'];?>₽</h2>
                            ...
                            <div class="col-sm-4">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="images/home/ada4.jpg" alt="" />
                                            <h2><?php echo $row76['price'];?>₽</h2>
                                            <p><?php echo $row76['name'];?></p>
                                            <a href="ada4.php" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Купить</a>
                                        </div>
                                        <div class="product-overlay">
                                            <div class="overlay-content">
                                                <h2><?php echo $row76['price'];?>₽</h2>
                            ...
                            <div class="col-sm-4">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="images/home/ada5.jpg" alt="" />
                                            <h2><?php echo $row77['price'];?>₽</h2>
                                            <p><?php echo $row77['name'];?></p>
                                            <a href="ada5.php" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Купить</a>
                                        </div>
                                        <div class="product-overlay">
                                            <div class="overlay-content">
                                               <h2><?php echo $row77['price'];?>₽</h2>
                            ...
                            <div class="col-sm-4">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="images/home/ada6.jpg" alt="" />
                                            <h2><?php echo $row78['price'];?>₽</h2>
                                            <p><?php echo $row78['name'];?></p>
                                            <a href="ada6.php" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Купить</a>
                                        </div>
                                        <div class="product-overlay">
                                            <div class="overlay-content">
                                                <h2><?php echo $row78['price'];?>₽</h2>
