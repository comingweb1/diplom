                ...
                <div class="panel panel-default">
                    ...
                    <div class="col-sm-9 padding-right">
                        <div class="features_items"><!--features_items-->
                            <h2 class="title text-center">ТЕЛЕФОНЫ</h2>
                            <div class="col-sm-4">
                                    ...
                                    <div class="single-products">
                                        ...
                                        <div class="product-overlay">
                                            <div class="overlay-content">
                                                <h2><?php echo $row1['price'];?>₽</h2>
                                                <p><?php echo $row1['name'];?></p>
                                                <a href="tel1.php" class="btn btn-default add-to-cart" data-id="1"><i class="fa fa-shopping-cart"></i>Купить</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-4">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="images/home/tel1.jpg" alt="" />
                                            <h2><?php echo $row2['price'];?>₽</h2>
                                                <p><?php echo $row2['name'];?></p>
                                            <a href="tel2.php" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Купить</a>
                                        </div>
                                        <div class="product-overlay">
                                            <div class="overlay-content">
                                                <h2><?php echo $row2['price'];?>₽</h2>
                            ...
                            <div class="col-sm-4">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="images/home/tel2.jpg" alt="" />
                                            <h2><?php echo $row3['price'];?>₽</h2>
                                                <p><?php echo $row3['name'];?></p>
                                            <a href="tel3.php" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Купить</a>
                                        </div>
                                        <div class="product-overlay">
                                            <div class="overlay-content">
                                                <h2><?php echo $row3['price'];?>₽</h2>
                            ...
                            <div class="col-sm-4">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="images/home/tel3.jpg" alt="" />
                                            <h2><?php echo $row4['price'];?>₽</h2>
                                                <p><?php echo $row4['name'];?></p>
                                            <a href="tel4.php" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Купить</a>
                                        </div>
                                        <div class="product-overlay">
                                            <div class="overlay-content">
                                                <h2><?php echo $row4['price'];?>₽</h2>
                            ...
                            <div class="col-sm-4">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="images/home/tel4.jpg" alt="" />
                                             <h2><?php echo $row6['price'];?>₽</h2>
                                                <p><?php echo $row6['name'];?></p>
                                            <a href="tel6.php" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Купить</a>
                                        </div>
                                        <div class="product-overlay">
                                            <div class="overlay-content">
                                                <h2><?php echo $row6['price'];?>₽</h2>
                            ...
                            <div class="col-sm-4">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="images/home/tel6.jpg" alt="" />
                                            <h2><?php echo $row7['price'];?>₽</h2>
                                                <p><?php echo $row7['name'];?></p>
                                            <a href="tel7.php" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Купить</a>
                                        </div>
                                        <div class="product-overlay">
                                            <div class="overlay-content">
                                                <h2><?php echo $row7['price'];?>₽</h2>
                            ...
                            <div class="col-sm-4">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="images/home/tel7.jpg" alt="" />
                                            <h2><?php echo $row8['price'];?>₽</h2>
                                                <p><?php echo $row8['name'];?></p>
                                            <a href="tel8.php" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Купить</a>
                                        </div>
                                        <div class="product-overlay">
                                            <div class="overlay-content">
                                              <h2><?php echo $row8['price'];?>₽</h2>
                            ...
                            <div class="col-sm-4">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="images/home/tel8.jpg" alt="" />
                                            <h2><?php echo $row9['price'];?>₽</h2>
                                                <p><?php echo $row9['name'];?></p>
                                            <a href="tel9.php" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Купить</a>
                                        </div>
                                        <div class="product-overlay">
                                            <div class="overlay-content">
                                                <h2><?php echo $row9['price'];?>₽</h2>
                            ...
                            <div class="col-sm-4">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="images/home/tel9.jpg" alt="" />
                                            <h2><?php echo $row10['price'];?>₽</h2>
                                                <p><?php echo $row10['name'];?></p>
                                            <a href="tel10.php" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Купить</a>
                                        </div>
                                        <div class="product-overlay">
                                            <div class="overlay-content">
                                                <h2><?php echo $row10['price'];?>₽</h2>
                            ...
                            <div class="col-sm-4">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="images/home/tel10.jpg" alt="" />
                                            <h2><?php echo $row11['price'];?>₽</h2>
                                                <p><?php echo $row11['name'];?></p>
                                            <a href="tel11.php" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Купить</a>
                                        </div>
                                        <div class="product-overlay">
                                            <div class="overlay-content">
                                                <h2><?php echo $row11['price'];?>₽</h2>
                            ...
                            <div class="col-sm-4">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="images/home/tel11.jpg" alt="" />
                                            <h2><?php echo $row12['price'];?>₽</h2>
                                                <p><?php echo $row12['name'];?></p>
                                            <a href="tel12.php" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Купить</a>
                                        </div>
                                        <div class="product-overlay">
                                            <div class="overlay-content">
                                                <h2><?php echo $row12['price'];?>₽</h2>
